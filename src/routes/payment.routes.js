...
router.post('/checkout', isAuthenticated, upload.single('receipt'), paymentController.processCheckout);
...
router.post('/orders/:id/receive', isAuthenticated, paymentController.receiveOrder);
